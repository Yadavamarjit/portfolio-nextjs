...
export const HeroSection = () => {
  return (
    <div className="py-32 md:py-48 lg:py-60 z-0 relative">
      ...
      ></div>
      <div className="absolute overflow-hidden inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
      ...
      <div className="container">
        <div className="flex items-center flex-col">
          ...
          <div className="bg-gray-950 border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg">
            ...
            <div className="bg-green-500 size-2.5 rounded-full relative">
              {" "}
              <div className="bg-green-500 size-2.5 rounded-full animate-ping absolute inset-0"></div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-lg">
          ...
          <p className="text-center text-white/60 mt-4 md:text-lg">
            Building systems that scale, and UIs that captivate.
          </p>
        </div>
